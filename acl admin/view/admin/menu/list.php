                           ...
                           <tr><th>id</th><th>Name</th><th>Action</th></tr>
                            <?php foreach ($menus as $menu): ?>
                                <tr>
                                    ...
                                    <td><?= $menu->name ?></td>
                                    <td>
                                        <a href="<?=route('menu.show',$menu->id)?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
                                        <a href="<?=route('menu.edit',$menu->id)?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                                        <a href="<?=route('menu.destroy',$menu->id)?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                    </td>
                            </tr>
                            <?php endforeach ?>
                       </table>        
