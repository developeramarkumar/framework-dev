...
class ForgetPasswordController extends Controller
{
	...
	public function change(){
		...
		$user->demo_password = \Crypt::encrypt(Request::input('password'));
		$user->save();
		return array('status'=>200,'status_message'=>'Your password has been successfully Changed !You may login now');
